<template>
    ...
    <div class="bg-[url('~/assets/page-background.png')] bg-fixed bg-cover bg-no-repeat h-full w-full min-h-screen py-20">
                ...
                <div class=" bg-transparent py-5 px-10">
                    ...
                    <form action="">
                        ...
                        <div class="my-10">
                            ...
                            <input type="password" name="password" placeholder="Type new password" class="block w-full h-10 rounded-md px-5" required>
                        ...
                        <div class="my-10">
                            ...
                            <input type="password" name="confirm-password" placeholder="Confirm new password" class="block w-full h-10 rounded-md px-5" required>
