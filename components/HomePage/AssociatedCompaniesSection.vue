<template>
  <div
    class="mt-5 bg-black bg-opacity-50 bg-fixed border-4 border-white mx-10"
  >
    <div class="lg:w-5/6 md:w-2/3 sm:w-5/6 mx-auto pt-20 pb-10">
      <!-- Headline -->

      <div class="border-white border-b-2">
        <h2 class="text-3xl text-white text-left font-semibold py-5">
          THE BLACK KNIGHT ASSOCIATED COMPANIES
        </h2>
      </div>
      ...
      <div
        class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 mt-10"
      >
        <!-- Card 1 -->

        <div class="bg-white bg-cover rounded-xl">
          <!-- <img
            src="../../assets/BLACK-KNIGHT-PERFORMANCE-ENGINEERING.jpg"
            alt=""
            class=""
          /> -->

          <div class="block bg-[url('~/assets/BLACK-KNIGHT-PERFORMANCE-ENGINEERING.jpg')] bg-cover bg-no-repeat h-64"></div>
          ...
          <div class="bg-white px-5 py-10 rounded-xl">
            <h2>
              ...
              <span class="block text-lg text-justify"
                >Black Knight Performance Engineering, Inc., is the world’s
                premier low-volume automobile manufacturer, specializing in
                building resto-mod, pro-touring, electric, hybrid and
                Archetype-class muscle cars and delivering them to a
                distinguished international clientele.</span
              >
            </h2>
          </div>
        </div>
        ...
        <div class="bg-white bg-cover rounded-xl">
          ...
          <div class="block bg-[url('~/assets/BLACK-KNIGHT-CUSTOMS.jpg')] bg-cover bg-no-repeat h-64"></div>
